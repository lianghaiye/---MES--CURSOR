...
export const salesOrderDetailLineColumns = [
  ...
  { key: 'packagingForm', title: '包装形式', dataIndex: 'packagingForm', width: 90 },
  {
    ...
    title: '工业标识',
    dataIndex: 'needIndustrialLabel',
    width: 88,
    align: 'center',
  },
  {
    key: 'industrialLabelStatus',
    title: '标识状态',
    dataIndex: 'industrialLabelStatus',
    width: 100,
  },
  {
    key: 'industrialLabelSuccessCount',
    title: '标识成功数',
    dataIndex: 'industrialLabelSuccessCount',
    width: 96,
    align: 'right',
  },
  {
