  ...
  <div class="page-wrapper">
    ...
    <template v-if="currentView === 'list'">
      <div class="page-card">
        ...
        <div class="sub-tabs">
          <router-link to="/industrial-id/base-config/enterprise-info" class="sub-tab">企业信息</router-link>
          <router-link to="/industrial-id/base-config/product-template" class="sub-tab active">配置产品信息更新模板</router-link>
          <router-link to="/industrial-id/base-config/nameplate-template" class="sub-tab">配置铭牌模板</router-link>
        </div>
