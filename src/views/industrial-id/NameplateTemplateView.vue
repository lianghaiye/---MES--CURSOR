    ...
    <template v-if="currentView === 'list'">
      <div class="page-card">
        ...
        <div class="sub-tabs">
          ...
          <router-link to="/industrial-id/base-config/product-template" class="sub-tab">配置产品信息更新模板</router-link>
          <router-link to="/industrial-id/base-config/nameplate-template" class="sub-tab active">配置铭牌模板</router-link>
        </div>
