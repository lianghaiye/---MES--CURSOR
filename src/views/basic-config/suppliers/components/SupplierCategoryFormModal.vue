...
import { addSupplierCategory, updateSupplierCategory } from '@/store/supplierCategoryStore'
...
function handleSave() {
  ...
  const res = isEdit.value
    ? updateSupplierCategory(props.record.id, { ...form })
    : addSupplierCategory({ ...form })
  saving.value = false
  if (!res.ok) {
