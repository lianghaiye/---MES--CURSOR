<template>
  <div
    class="purchase-order-print-preview-page purchase-return-print-preview-page"
    :class="pageClass"
  >
...
import { loadPurchaseReturnPrintPayload } from '@/utils/purchaseReturnPrintPreview'
import { printElement } from '@/utils/browserPrint'

const route = useRoute()
const printAreaRef = ref(null)

const payload = computed(() => loadPurchaseReturnPrintPayload(route.query.key))
...
function handlePrint() {
  ...
  printElement(printAreaRef.value, {
    title: printSheets.value[0]?.returnNo || '采购退货明细',
...
<style scoped>
.purchase-return-print-preview-page {
  min-height: 100vh;
  background: #e8e8e8;
  padding-bottom: 24px;
}
