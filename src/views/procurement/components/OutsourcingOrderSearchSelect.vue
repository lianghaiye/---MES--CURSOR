<template>
  ...
  <OutsourcingOrderSelectModal v-model:open="pickerOpen" @confirm="onPickedFromModal" />
</template>
...
import {
  OUTSOURCING_ORDER_DROPDOWN_QUICK_LIMIT,
  OUTSOURCING_ORDER_SELECT_PLACEHOLDER,
  buildOutsourcingOrderDisplayOptions,
  getAllOutsourcingOrderOptions,
} from '@/utils/outsourcingOrderPicker'
import OutsourcingOrderSelectModal from './OutsourcingOrderSelectModal.vue'

const props = defineProps({
  value: { type: String, default: '' },
  placeholder: { type: String, default: OUTSOURCING_ORDER_SELECT_PLACEHOLDER },
...
const allOptions = computed(() => getAllOutsourcingOrderOptions(outsourcingOrderState.orders))
...
const displayOptions = computed(() =>
  buildOutsourcingOrderDisplayOptions({
    ...
    quickLimit: OUTSOURCING_ORDER_DROPDOWN_QUICK_LIMIT,
  }),
)
...
<script>
export default { name: 'OutsourcingOrderSearchSelect' }
</script>
