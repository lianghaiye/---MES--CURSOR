...
import {
  SALES_ORDER_DROPDOWN_QUICK_LIMIT,
  SALES_ORDER_SELECT_PLACEHOLDER,
...
const props = defineProps({
  ...
  placeholder: { type: String, default: SALES_ORDER_SELECT_PLACEHOLDER },
...
const displayOptions = computed(() =>
  buildSalesOrderDisplayOptions({
    ...
    quickLimit: SALES_ORDER_DROPDOWN_QUICK_LIMIT,
  }),
)
...
<script>
export default { name: 'SalesOrderSearchSelect' }
</script>
