<template>
  <div class="purchase-order-print-preview-page purchase-req-print-preview-page" :class="pageClass">
      ...
      <div ref="printAreaRef" class="preview-canvas">
        ...
        >
          ...
          <section class="sheet-section">
            ...
            <div v-else class="bom-empty">暂无申请明细</div>
...
import { loadPurchaseRequisitionPrintPayload } from '@/utils/purchaseRequisitionPrintPreview'
import { printElement } from '@/utils/browserPrint'

defineOptions({ name: 'PurchaseRequisitionPrintPreviewView' })

const route = useRoute()
const printAreaRef = ref(null)

const payload = computed(() => loadPurchaseRequisitionPrintPayload(route.query.key))
...
function handlePrint() {
  ...
  printElement(printAreaRef.value, {
    title: printSheets.value[0]?.reqNo || '采购申请明细',
...
<style scoped>
.purchase-req-print-preview-page {
  min-height: 100vh;
  background: #e8e8e8;
  padding-bottom: 24px;
}
