<template>
  <div
    class="purchase-order-print-preview-page purchase-receipt-print-preview-page"
    :class="pageClass"
  >
...
import { loadPurchaseReceiptPrintPayload } from '@/utils/purchaseReceiptPrintPreview'
import { printElement } from '@/utils/browserPrint'

const route = useRoute()
const printAreaRef = ref(null)

const payload = computed(() => loadPurchaseReceiptPrintPayload(route.query.key))
...
function handlePrint() {
  ...
  printElement(printAreaRef.value, {
    title: printSheets.value[0]?.receiptNo || '采购收货明细',
...
<style scoped>
.purchase-receipt-print-preview-page {
  min-height: 100vh;
  background: #e8e8e8;
  padding-bottom: 24px;
}
