<template>
  <div class="prd-page">
    ...
    <a-alert
      ...
      class="prd-intro"
      message="云效建需求说明"
      description="共 8 条产品信息/物料信息需求，每条对应云效迭代「淄博泵产业互联网平台-1.5.1」中的一个工作项。Markdown 原文见 docs/yunxiao/淄博泵产业互联网平台-1.5.1-产品物料需求.md，可复制到云效描述中。"
    />
...
<script>
export default { name: 'PrdV151ProductMaterialView' }
</script>
...
import {
  PRD_V151_PM_META,
  PRD_V151_PRODUCT_MATERIAL_REQUIREMENTS,
} from '@/data/prdV151ProductMaterial'

const meta = PRD_V151_PM_META
const keyword = ref('')

const columns = [
  { title: '编号', dataIndex: 'id', key: 'id', width: 110 },
  { title: '需求标题', key: 'title', width: 260, ellipsis: true },
...
const filteredRequirements = computed(() => {
  ...
  if (!kw) return PRD_V151_PRODUCT_MATERIAL_REQUIREMENTS
  return PRD_V151_PRODUCT_MATERIAL_REQUIREMENTS.filter(
    (r) =>
