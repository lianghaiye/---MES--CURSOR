export const poStatusOptions = ['待审批', '进行中', '已完成']

export const poSourceOptions = ['新增', '采购申请', '外购销售']

export const inboundStatusOptions = ['未入库', '部分入库', '已入库']

export const applyTypeOptions = ['日常采购申请', '紧急采购申请', '计划采购申请']
...
export const approvalResultOptions = ['审批通过', '审批驳回', '待审批']
