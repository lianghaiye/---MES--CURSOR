...
function lineFromProduct(product, partial = {}) {
  ...
  return createLineItem({
    ...
    salesQty: qty,
    needIndustrialLabel: Boolean(product?.production?.needIndustrialLabel),
    taxRate,
    unitPriceExTax: ex,
      ...
      deliveryApplications: [
        {
          ...
          shipmentMethod: '物流',
          logisticsNo: 'YT886600112233',
          deliveryAddress: '济南市历下区工业南路 100 号',
          outboundWarehouse: '成品仓',
          driverName: '王师傅',
          driverPhone: '13600005555',
          plateNo: '鲁A88888',
          status: '已提交',
          remark: '首批整机发运',
          totalShipQty: 3,
