...
export function cloneInboundSeedOrders() {
  ...
  return [
    ...
    // ——— 类型覆盖：补齐选项中尚缺演示单的入库类型 ———
    createInboundOrder({
      id: 'ib-type-stocktake-1',
      docNo: 'PDYK-20260920001',
      inboundType: '盘点入库',
      status: '已入库',
      sourceChannel: INBOUND_SOURCE.BUSINESS,
      warehouse: '原料仓',
      warehouseKeeper: 'admin1',
      inboundDate: '2026-09-20',
      itemType: '物料',
      sourceOrderNo: 'PD20260920001',
      sourceType: '库存盘点',
      stocktakeOrderId: 'st-type-seed-1',
      stocktakeDocNo: 'PD20260920001',
      handler: 'admin1',
      creator: 'admin1',
      createdAt: '2026-09-20 09:25:00',
      confirmer: 'admin1',
      confirmedAt: '2026-09-20 09:30:00',
      remark: '类型覆盖：盘点盘盈入库',
      lineItems: [
        createInboundLine({
          id: 'ib-type-stocktake-1-l1',
    ...
    createInboundOrder({
      id: 'ib-type-transfer-1',
      docNo: 'DBRK-20260920001',
      inboundType: '调拨入库',
      status: '待入库',
      sourceChannel: INBOUND_SOURCE.BUSINESS,
      warehouse: '半成品仓',
      ...
      outboundOrderId: 'ob-type-transfer-1',
      outboundDocNo: 'DBCK-20260920001',
      handler: 'admin1',
      creator: 'admin1',
      createdAt: '2026-09-20 13:05:00',
      remark: '类型覆盖：调拨入库待签收（关联 DBCK-20260920001）',
      lineItems: [
        createInboundLine({
          id: 'ib-type-transfer-1-l1',
          ...
          lineStatus: '待入库',
          transferSoftReceive: true,
          linkedOutboundLineId: 'ob-type-transfer-1-l1',
        }),
      ],
    }),
    createInboundOrder({
      id: 'ib-type-scrap-1',
      docNo: 'BFRK-20260920001',
      inboundType: '报废入库',
      status: '已入库',
      sourceChannel: INBOUND_SOURCE.BUSINESS,
      warehouse: '报废仓',
      ...
      handler: '李四',
      creator: '李四',
      createdAt: '2026-09-20 15:10:00',
      confirmer: 'admin1',
      confirmedAt: '2026-09-20 15:20:00',
      remark: '类型覆盖：报废财物变现入库',
      lineItems: [
        createInboundLine({
          id: 'ib-type-scrap-1-l1',
    ...
    createInboundOrder({
      id: 'ib-type-remnant-1',
      docNo: 'YLRK-20260920001',
      inboundType: '余料入库',
      status: '已入库',
      sourceChannel: INBOUND_SOURCE.BUSINESS,
      warehouse: '原料仓',
      ...
      inboundDate: '2026-09-20',
      itemType: '物料',
      sourceOrderNo: 'JS20260920001',
      sourceType: '下料结算',
      handler: '张三',
      creator: '张三',
      createdAt: '2026-09-20 16:20:00',
      confirmer: 'admin1',
      confirmedAt: '2026-09-20 16:25:00',
      remark: '类型覆盖：下料结算余料回仓',
      lineItems: [
        createInboundLine({
          id: 'ib-type-remnant-1-l1',
          itemCode: 'WL-PIPE-Q235-50',
          itemName: '无缝钢管 Q235 φ50×3',
          qty: 1.2,
          unit: '米',
    ...
    createInboundOrder({
      id: 'ib-type-other-1',
      docNo: '1-20260920-QT01',
      inboundType: '其他入库',
      status: '待入库',
      sourceChannel: INBOUND_SOURCE.MANUAL,
      warehouse: '原料仓',
      warehouseKeeper: 'admin1',
      inboundDate: '2026-09-20',
      itemType: '物料',
      ...
      remark: '类型覆盖：其他入库（盘盈手工补录）',
      lineItems: [
        createInboundLine({
          id: 'ib-type-other-1-l1',
