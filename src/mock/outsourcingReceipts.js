...
export const mockOutsourcingReceipts = [
  ...
  createOutsourcingReceipt({
    id: 'wxrct-4',
    receiptNo: 'WXSH-260918-001',
    qcNo: 'WXHJ202609180001',
    outsourcingOrderNo: 'WX-260808001',
    outsourcingOrderId: 'wx-1',
    supplier: '机加工外协厂',
    contactPerson: '赵工',
    purchaser: '外协员王芳',
    qcStatus: '质检中',
  ...
  createOutsourcingReceipt({
    id: 'wxrct-5',
    receiptNo: 'WXSH-260916-001',
    qcNo: 'WXHJ202609160001',
    outsourcingOrderNo: 'WX-260806001',
    outsourcingOrderId: 'wx-3',
    supplier: '铸造外协厂',
    contactPerson: '钱工',
    purchaser: 'admin1',
    qcStatus: '质检不通过',
    qcResult: '不合格',
    inspector: '质检员A',
    inspectedAt: '2026-09-16 16:40',
    receiptStatus: '进行中',
    inboundStatus: '待入库',
    createdAt: '2026-09-16 09:40',
    updatedAt: '2026-09-16 16:40',
    lineItems: [
      {
        id: 'wxrct-5-l1',
        productName: '泵体半成品',
        productCode: 'SEMI-HOUSING-01',
        itemName: '泵体半成品',
  ...
  createOutsourcingReceipt({
    ...
    qcResult: '部分合格',
    inspector: '质检员C',
    inspectedAt: '2026-09-15 14:25',
    receiptStatus: '已完成',
    inboundStatus: '入库中',
    createdAt: '2026-09-15 08:40',
