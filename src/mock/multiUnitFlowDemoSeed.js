...
export const MULTI_UNIT_FLOW_IDS = {
  ...
  batchCastingA: 'bat-mu-flow-casting-8',
  batchCastingB: 'bat-mu-flow-casting-12',
  /** 无主数据默认率：用批次单量 11.2 kg/件 做开单预估 */
  batchCastingNorate: 'bat-mu-flow-casting-norate',
}
...
export function createMultiUnitFlowBatches() {
  ...
  return [
    ...
    {
      id: MULTI_UNIT_FLOW_IDS.batchCastingA,
      batchNo: 'B-260824-920',
      parentBatchId: '',
      warehouse: '原料仓',
      ...
      status: '在库',
      sourceType: '采购入库',
      sourceDocNo: 'MU-IB-SETTLE-001',
      createdAt: '2026-08-24T12:00:00.000Z',
      updatedAt: '2026-08-24T12:00:00.000Z',
      attrs: { material: 'HT250', specModel: '泵体', barcodeType: '一批一码' },
      uomConvert: {
        convertType: 'batch',
        pieceCount: 8,
        settleQty: 98.4,
        settleUnit: 'kg',
        actualUnitWeight: 12.3,
        standardUnitWeight: 12.3,
        stockQty: 8,
        stockUnit: '件',
      },
      remark: '按批次覆盖：过磅 98.4kg / 8件 → 单重 12.3',
    },
    {
      id: MULTI_UNIT_FLOW_IDS.batchCastingB,
      batchNo: 'B-260824-921',
      parentBatchId: '',
      warehouse: '原料仓',
      itemCode: CASTING_BLANK_SETTLE_CODE,
      itemName: CASTING_BLANK_SETTLE_NAME,
      ...
      uomConvert: {
        ...
        settleQty: 149.04,
        settleUnit: 'kg',
        actualUnitWeight: 12.42,
        standardUnitWeight: 12.3,
        stockQty: 12,
        stockUnit: '件',
      },
      remark: '按批次覆盖：过磅略高于默认单重',
    },
    {
      id: MULTI_UNIT_FLOW_IDS.batchCastingNorate,
      batchNo: 'B-260825-930',
      parentBatchId: '',
      warehouse: '原料仓',
      ...
      status: '在库',
      sourceType: '采购入库',
      sourceDocNo: 'IN-MU-FLOW-CAST-NORATE',
      createdAt: '2026-08-25T10:00:00.000Z',
      updatedAt: '2026-08-25T10:00:00.000Z',
      attrs: { material: 'HT200', specModel: '异形', barcodeType: '一批一码' },
      uomConvert: {
        convertType: 'batch',
        pieceCount: 5,
        settleQty: 56,
        settleUnit: 'kg',
        actualUnitWeight: 11.2,
        standardUnitWeight: null,
        stockQty: 5,
        stockUnit: '件',
      },
      remark: '无主数据默认率：过磅 56kg / 5件 → 批次单量 11.2，供下次开单预估',
    },
  ]
}
