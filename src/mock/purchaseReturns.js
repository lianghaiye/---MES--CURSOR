...
export const mockPurchaseReturns = [
  createPurchaseReturn({
    ...
    outboundStatus: '待出库',
    shipWarehouse: '原材料仓',
    outboundOrderNo: 'CKTH-260807001',
    outboundOrderId: 'ob-prtn-1',
    returnAddress: '供应商仓库退回',
    createdAt: '2026-08-07 11:00:00',
    updatedAt: '2026-08-07 11:30:00',
    updater: 'admin1',
    outboundOrders: [
      createPurchaseReturnOutboundOrder({
        ...
        shipWarehouse: '原材料仓',
        outboundStatus: '待出库',
        createdAt: '2026-08-07 11:30:00',
        lineItems: [
          createPurchaseReturnOutboundLine({
            returnLineId: 'prtn-1-l1',
            productName: '钢板',
