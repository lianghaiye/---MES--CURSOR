...
export function buildMockEcnRecords() {
  ...
  const raw = [
    ...
    },
    {
      ...
      wipHandling: ECN_WIP_HANDLING.EBOM_WITH_ONLINE_WO_SWITCH,
    ...
    enrichRecord(
      {
        ...
        impact: {
          products: 1,
          bomLines: row.changeItems?.length || 1,
          wipOrders: 2,
          inventoryWarnings: 0,
        },
        attachments: [],
